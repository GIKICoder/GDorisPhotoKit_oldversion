...
- (void)configAsset:(GDorisAsset *)assetModel
{
    self.imageView.image = [assetModel.asset thumbnailImageWithSize:self.bounds.size];
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.assetModels.count > indexPath.item) {
        GDorisAsset * assetModel = [self.assetModels objectAtIndex:indexPath.item];
