//
//  GDorisTiledImageBuilder+CGImage.m
...
#import "GDorisTiledImageBuilder+CGImage.h"
...
@implementation GDorisTiledImageBuilder (CGImage)
...
- (CGImageRef)newImageForScale:(CGFloat)scale location:(CGPoint)origPt box:(CGRect)box
{
    ...
    CGImageRef image = CGImageCreate(
                                     ...
                                     4*bitsPerComponent,
                                     tileBytesPerRow,
                                     [GDorisTiledImageBuilder colorSpace],
