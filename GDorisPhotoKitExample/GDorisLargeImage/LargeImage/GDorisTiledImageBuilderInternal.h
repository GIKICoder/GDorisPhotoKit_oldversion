//
//  GDorisTiledImageBuilderInternal.h
...
#ifndef GDorisTiledImageBuilderInternal_h
...
@interface GDorisTiledImageBuilder ()
...
@interface GDorisTiledImageBuilder (Tile)
...
@end
#endif
#endif /* GDorisTiledImageBuilderInternal_h */
