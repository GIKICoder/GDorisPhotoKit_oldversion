...
@implementation GDorisTiledImageBuilder
{
    NSString    *_imagePath;
    BOOL        mapWholeFile;
}
...
+ (void)initialize
{
    if(self == [GDorisTiledImageBuilder class]) {
        colorSpace = CGColorSpaceCreateDeviceRGB();
        
        fileFlushQueue = dispatch_queue_create("com.dfh.GDorisTiledImageBuilder", DISPATCH_QUEUE_SERIAL);
